        ...
        <>
            ...
            <div className='bg-white dark:bg-zinc-950 sticky top-0 z-50'>
                <div className='max-container flex items-center justify-between pt-3 pb-3'>
                    <div
                        className='menu-bar text-yellow-600 cursor-pointer opacity-0 max-sm:opacity-100'
                ...
                <div
                    className={`bg-gray-50 dark:bg-zinc-900 py-3 flex items-center justify-center gap-5 mobile-menu ${
